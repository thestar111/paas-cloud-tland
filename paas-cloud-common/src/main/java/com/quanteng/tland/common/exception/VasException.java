...
public class VasException extends RuntimeException
{
	 ...
	 * initialized by a call to {@link #initCause}.
	 */
	public VasException (String resultCode, String resultMessage)
	{
		super (resultMessage);
	 ...
	 * @since 1.4
	 */
	public VasException (String resultMessage, String resultCode, Throwable cause)
	{
	...
	{
		final StringBuilder sb = new StringBuilder ("VasException{");
