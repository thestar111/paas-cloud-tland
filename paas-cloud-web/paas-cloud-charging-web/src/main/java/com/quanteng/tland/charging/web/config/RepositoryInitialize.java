...
import com.quanteng.tland.common.exception.CharingException;
...
public class RepositoryInitialize
{
	 ...
	 * 实体类包路径
	 */
	private static final String MODEL_PACKAGE_PATH = "com.quanteng.tland.charging.database.entity";
	...
	public SqlSessionFactory sqlSessionFactory ()
	{
		...
		catch (Exception e)
		{
			...
			throw new CharingException ("99999999", "init database failed.");
		}
	}
