 ...
 * 修改内容:  <修改内容>
 */
package com.quanteng.tland.cms.web.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.quanteng.tland.common.exception.CmsException;
...
public class RepositoryInitialize
{
	 ...
	 * 实体类包路径
	 */
	private static final String MODEL_PACKAGE_PATH = "com.quanteng.tland.cms.database.entity";
	...
	public SqlSessionFactory sqlSessionFactory ()
	{
		...
		catch (Exception e)
		{
			...
			throw new CmsException ("99999999", "init database failed.");
		}
	}
