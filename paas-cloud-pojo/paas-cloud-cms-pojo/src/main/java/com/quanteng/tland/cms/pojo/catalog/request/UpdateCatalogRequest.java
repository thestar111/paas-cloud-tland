...
@Getter
@Setter
public class UpdateCatalogRequest extends BaseRequest
{

	/**
	 * 栏目信息
	 */
	private CatalogVo catalogs;

	@Override
	public String toString ()
	{
		final StringBuilder sb = new StringBuilder ("UpdateCatalogRequest{");
