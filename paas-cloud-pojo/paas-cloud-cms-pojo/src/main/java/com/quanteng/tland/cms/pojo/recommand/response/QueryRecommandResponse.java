 ...
 * 修改内容:  <修改内容>
 */
package com.quanteng.tland.cms.pojo.recommand.response;
...
@Getter
@Setter
public class QueryRecommandResponse extends Result
{
	...
	{
		final StringBuilder sb = new StringBuilder ("QueryRecommandResponse{");
