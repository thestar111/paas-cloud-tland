...
@Getter
@Setter
public class ModifyPartnerRequest extends BaseRequest
{
	/**
	 * CP信息
	 */
	private CpInfoVo cpInfo;

	@Override
	public String toString ()
	{
		final StringBuilder sb = new StringBuilder ("ModifyPartnerRequest{");
