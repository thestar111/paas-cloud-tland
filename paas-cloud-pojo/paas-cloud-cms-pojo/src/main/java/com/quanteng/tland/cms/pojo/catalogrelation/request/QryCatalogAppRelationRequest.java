/**
 * 文 件 名:  QryColumnAppRelaInfoRequest
...
@Getter
@Setter
public class QryCatalogAppRelationRequest extends BasePageRequest
{
	/**
	 * 栏目编号
	 */
	...
	{
		final StringBuilder sb = new StringBuilder ("QryCatalogAppRelationRequest{");
